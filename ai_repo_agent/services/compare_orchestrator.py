...
from ai_repo_agent.db.repositories import DependencyStore, FindingStore, SnapshotStore


class CompareOrchestrator:
    """Compare snapshots for a repository."""

    def __init__(self, snapshot_store: SnapshotStore, finding_store: FindingStore, dependency_store: DependencyStore) -> None:
